  ...
  const groupedExams = [
    {
      id: 'registration',
      display: 'Anmeldung',
      exams: useSelector(selectExamOffers),
    },
            ...
            >
              ...
              {exams
                ...
                .map(
                  ({
                    exam,
                    exam: { id, courseName, examName, date, status, grade },
                  }) => (
                    <ListGroup.Item
                      key={id}
                      action
                    ...
                    >
                      <div style={{ flexGrow: 1, overflow: 'hidden' }}>
                        ...
                        <div>
                          {grade ? (
                            <Badge pill variant={convertGrade(grade).color}>
                              {convertGrade(grade).desc} ({grade})
                            </Badge>
                          ) : (
                            <>{date}</>
                          )}
